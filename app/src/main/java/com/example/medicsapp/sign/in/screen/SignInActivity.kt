...
class SignInActivity : BaseActivity(), View.OnClickListener {
    ...
    private fun modifySubString() {
        ...
        spannableString.modifyString(this, getString(R.string.don_t_have_an_account_sign_up), getString(R.string.sign_up), R.color.primaryColor, true, this, SignInActivity::class.java)
